...
- Android：`v0.3.5-ear-position-ahoge-hierarchy-test`，**本轮制作、待实机确认**。
- Windows：`Sen VTS Parameter Capture v0.1.0`，**核心采集流程已电脑确认**。
- 固定顺序：静态部件缺失/错层已经由C高精度蒙版解决；本轮修正耳鳍角度方向和上下位置，并按Cubism Part层级重新定位长呆毛。实机确认以后，才恢复物理、九轴、表情、动作和AI功能。

## 最近构建记录

### 2026-08-30 · v0.3.5 耳鳍位置与呆毛层级修复（本轮制作、待实机确认）
